...
namespace SpellforceDataEditor.SFLua.lua_sql_forms
{
    public partial class SFLuaSQLBuildingForm : Form
    {
        ...
        {
            if (LuaSQLDatabase.buildings.Load(MainForm.lua) != 0)
            {
        ...
        private void ReloadBuildingList()
        {
            ...
            var buildings = LuaSQLDatabase.buildings.items;
        ...
        private void SelectionSize_Validated(object sender, EventArgs e)
        {
            ...
            LuaSQLDatabase.buildings.items[selected_id].SelectionScaling =
        ...
        private void BuildingID_Validated(object sender, EventArgs e)
        {
            ...
            SFEngine.SFLua.lua_sql.SFLuaSQLBuildingData building = LuaSQLDatabase.buildings.items[previous_id];
            ...
            LuaSQLDatabase.buildings.items.Remove(selected_id);
            ...
            LuaSQLDatabase.buildings.items.Add(new_id, building);
        ...
        private void ButtonAdd_Click(object sender, EventArgs e)
        {
            ...
            LuaSQLDatabase.buildings.items.Add(0, building);
        ...
        {
            if (LuaSQLDatabase.buildings.Save() != 0)
            {

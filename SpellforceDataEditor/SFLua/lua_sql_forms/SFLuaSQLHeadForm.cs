...
namespace SpellforceDataEditor.SFLua.lua_sql_forms
{
    public partial class SFLuaSQLHeadForm : Form
    {
        ...
        {
            if (LuaSQLDatabase.heads.Load(MainForm.lua) != 0)
            {
        ...
        private void ReloadHeadList()
        {
            ...
            for (int i = 0; i < LuaSQLDatabase.heads.items.Count; i++)
            {
        ...
        private void ListHeads_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            var heads = LuaSQLDatabase.heads.items;
        ...
        private void MM_Validated(object sender, EventArgs e)
        {
            ...
            LuaSQLDatabase.heads.items[ListHeads.SelectedIndex + 1].MeshMale = MM.Text.ToString();
        }
        ...
        private void MF_Validated(object sender, EventArgs e)
        {
            ...
            LuaSQLDatabase.heads.items[ListHeads.SelectedIndex + 1].MeshFemale = MF.Text.ToString();
        }
        ...
        private void ButtonAdd_Click(object sender, EventArgs e)
        {
            ...
            int new_id = LuaSQLDatabase.heads.items.Count + 1;
            LuaSQLDatabase.heads.items.Add(new_id, head);
        ...
        private void ButtonRemove_Click(object sender, EventArgs e)
        {
            ...
            LuaSQLDatabase.heads.items.Remove(ListHeads.SelectedIndex + 1);
            ListHeads.Items.RemoveAt(ListHeads.SelectedIndex);

            if (old_index == LuaSQLDatabase.heads.items.Count)
            {
                old_index -= 1;
            }
        ...
        {
            if (LuaSQLDatabase.heads.Save() != 0)
            {

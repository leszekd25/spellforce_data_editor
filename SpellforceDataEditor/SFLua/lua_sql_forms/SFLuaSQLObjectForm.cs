...
namespace SpellforceDataEditor.SFLua.lua_sql_forms
{
    public partial class SFLuaSQLObjectForm : Form
    {
        ...
        {
            if (LuaSQLDatabase.objects.Load(MainForm.lua) != 0)
            {
        ...
        private void ReloadObjectList()
        {
            ...
            var objects = LuaSQLDatabase.objects.items;
        ...
        private void ObjName_Validated(object sender, EventArgs e)
        {
            ...
            LuaSQLDatabase.objects.items[selected_id].Name = ObjName.Text.ToString();
        }
        ...
        private void CastsShadow_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            LuaSQLDatabase.objects.items[selected_id].Shadow = (CastsShadow.SelectedIndex == 1 ? true : false);
        }
        ...
        private void IsBillboarded_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            LuaSQLDatabase.objects.items[selected_id].Billboarded = (IsBillboarded.SelectedIndex == 1 ? true : false);
        }
        ...
        private void Scale_Validated(object sender, EventArgs e)
        {
            ...
            LuaSQLDatabase.objects.items[selected_id].Scale =
                (double)SFEngine.Utility.TryParseUInt32(ObjScale.Text,
                                               (uint)LuaSQLDatabase.objects.items[selected_id].Scale);
        }
        ...
        private void SelectionSize_Validated(object sender, EventArgs e)
        {
            ...
            LuaSQLDatabase.objects.items[selected_id].SelectionScaling =
        ...
        private void ObjectID_Validated(object sender, EventArgs e)
        {
            ...
            SFEngine.SFLua.lua_sql.SFLuaSQLObjectData obj = LuaSQLDatabase.objects.items[previous_id];
            ...
            LuaSQLDatabase.objects.items.Remove(selected_id);
            ...
            LuaSQLDatabase.objects.items.Add(new_id, obj);
        ...
        private void ButtonAdd_Click(object sender, EventArgs e)
        {
            ...
            LuaSQLDatabase.objects.items.Add(0, obj);
        ...
        {
            if (LuaSQLDatabase.objects.Save() != 0)
            {

...
namespace SpellforceDataEditor.SFCFF.category_forms
{
    public partial class Control18 : SpellforceDataEditor.SFCFF.category_forms.SFControl
    {
        ...
        {
            set_element_variant(current_element, 2, SFEngine.Utility.TryParseUInt16(textBox3.Text));
        }

        private void textBox4_TextChanged(object sender, EventArgs e)
        {
            set_element_variant(current_element, 3, SFEngine.Utility.TryParseUInt32(textBox4.Text));
        }

        private void textBox5_TextChanged(object sender, EventArgs e)
        {
            set_element_variant(current_element, 4, SFEngine.Utility.TryParseUInt16(textBox5.Text));
        }

        private void textBox6_TextChanged(object sender, EventArgs e)
        {
            set_element_variant(current_element, 5, SFEngine.Utility.TryParseUInt32(textBox6.Text));
        }

        private void textBox7_TextChanged(object sender, EventArgs e)
        {
            set_element_variant(current_element, 6, SFEngine.Utility.TryParseUInt16(textBox7.Text));
        }
        ...
        {
            set_element_variant(current_element, 9, SFEngine.Utility.TryParseUInt16(textBox12.Text));
        }

        private void textBox13_TextChanged(object sender, EventArgs e)
        {
            set_element_variant(current_element, 10, SFString.FromString(textBox13.Text, 0, 512));// SFEngine.Utility.FixedLengthString(textBox13.Text, 40));
        }

        private void textBox10_TextChanged(object sender, EventArgs e)
        {
            set_element_variant(current_element, 11, SFEngine.Utility.TryParseUInt8(textBox10.Text));
        }

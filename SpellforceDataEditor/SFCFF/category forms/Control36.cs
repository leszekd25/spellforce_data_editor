...
namespace SpellforceDataEditor.SFCFF.category_forms
{
    public partial class Control36 : SpellforceDataEditor.SFCFF.category_forms.SFControl
    {
        ...
        int get_subelem_index_by_slot_id(int slot_id)
        {
            ...
            {
                if (c2065[current_element, i].LootIndex == slot_id)
                {
                    return i;
                }
            }
        ...
        public override void set_element(int index)
        {
            ...
            for (int i = 0; i < c2065.GetItemSubItemNum(current_element); i++)
            {
                ...
                ListSlots.SetItemChecked(c2065[current_element, i].LootIndex, true);
            }
        ...
        {
            return $"{c2065[index, 0].ObjectID} {SFCategoryManager.GetUnitName(c2065[index, 0].ObjectID)} - {c2065.GetItemSubItemNum(index)} {((c2065.GetItemSubItemNum(index) == 1) ? "slot" : "slots")}";
        }

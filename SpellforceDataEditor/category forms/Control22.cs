...
namespace SpellforceDataEditor.category_forms
{
    public partial class Control22 : SpellforceDataEditor.category_forms.SFControl
    {
        ...
        {
            set_element_variant(current_element, 1, Utility.TryParseUInt8(textBox6.Text));
        }

        private void textBox2_TextChanged(object sender, EventArgs e)
        {
            set_element_variant(current_element, 2, Utility.TryParseUInt16(textBox2.Text));
        }
        ...
        {
            set_element_variant(current_element, 5, Utility.TryParseUInt8(textBox4.Text));
        }

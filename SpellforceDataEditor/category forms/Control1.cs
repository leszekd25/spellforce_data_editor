...
namespace SpellforceDataEditor.category_forms
{
    public partial class Control1 : SpellforceDataEditor.category_forms.SFControl
    {
        ...
        private void tb_sd1_TextChanged(object sender, EventArgs e)
        {
            ...
            category.set_element_variant(current_element, 19, data_array[0]);
            category.set_element_variant(current_element, 20, data_array[1]);
            category.set_element_variant(current_element, 21, data_array[2]);
            category.set_element_variant(current_element, 22, data_array[3]);
        }

        private void tb_sd2_TextChanged(object sender, EventArgs e)
        {
            Byte[] data_array = Utility.TryParseByteArray(tb_sd2.Text, 4);
            category.set_element_variant(current_element, 23, data_array[0]);
            category.set_element_variant(current_element, 24, data_array[1]);
            category.set_element_variant(current_element, 25, data_array[2]);
            category.set_element_variant(current_element, 26, data_array[3]);
        }

        private void tb_sd3_TextChanged(object sender, EventArgs e)
        {
            Byte[] data_array = Utility.TryParseByteArray(tb_sd3.Text, 4);
            category.set_element_variant(current_element, 27, data_array[0]);
            category.set_element_variant(current_element, 28, data_array[1]);
            category.set_element_variant(current_element, 29, data_array[2]);
            category.set_element_variant(current_element, 30, data_array[3]);
        }
        ...
        private void tb_sd5_TextChanged(object sender, EventArgs e)
        {
            ...
            category.set_element_variant(current_element, 35, data_array[0]);
            category.set_element_variant(current_element, 36, data_array[1]);
            category.set_element_variant(current_element, 37, data_array[2]);
            category.set_element_variant(current_element, 38, data_array[3]);
        }

        private void tb_sd6_TextChanged(object sender, EventArgs e)
        {
            Byte[] data_array = Utility.TryParseByteArray(tb_sd6.Text, 4);
            category.set_element_variant(current_element, 39, data_array[0]);
            category.set_element_variant(current_element, 40, data_array[1]);
            category.set_element_variant(current_element, 41, data_array[2]);
            category.set_element_variant(current_element, 42, data_array[3]);
        }

        private void tb_sd7_TextChanged(object sender, EventArgs e)
        {
            Byte[] data_array = Utility.TryParseByteArray(tb_sd7.Text, 4);
            category.set_element_variant(current_element, 43, data_array[0]);
            category.set_element_variant(current_element, 44, data_array[1]);
            category.set_element_variant(current_element, 45, data_array[2]);
            category.set_element_variant(current_element, 46, data_array[3]);
        }

        private void tb_sd8_TextChanged(object sender, EventArgs e)
        {
            Byte[] data_array = Utility.TryParseByteArray(tb_sd8.Text, 4);
            category.set_element_variant(current_element, 47, data_array[0]);
            category.set_element_variant(current_element, 48, data_array[1]);
            category.set_element_variant(current_element, 49, data_array[2]);
            category.set_element_variant(current_element, 50, data_array[3]);
        }

        private void tb_sd9_TextChanged(object sender, EventArgs e)
        {
            Byte[] data_array = Utility.TryParseByteArray(tb_sd9.Text, 4);
            category.set_element_variant(current_element, 51, data_array[0]);
            category.set_element_variant(current_element, 52, data_array[1]);
            category.set_element_variant(current_element, 53, data_array[2]);
            category.set_element_variant(current_element, 54, data_array[3]);
        }

        private void tb_sd10_TextChanged(object sender, EventArgs e)
        {
            Byte[] data_array = Utility.TryParseByteArray(tb_sd10.Text, 4);
            category.set_element_variant(current_element, 55, data_array[0]);
            category.set_element_variant(current_element, 56, data_array[1]);
            category.set_element_variant(current_element, 57, data_array[2]);
            category.set_element_variant(current_element, 58, data_array[3]);
        }

        private void tb_unk_TextChanged(object sender, EventArgs e)
        {
            Byte[] data_array = Utility.TryParseByteArray(tb_unk.Text, 4);
            category.set_element_variant(current_element, 59, data_array[0]);
            category.set_element_variant(current_element, 60, data_array[1]);
            category.set_element_variant(current_element, 61, data_array[2]);
            category.set_element_variant(current_element, 62, data_array[3]);
        }
    }
}

...
namespace SpellforceDataEditor.category_forms
{
    public partial class Control24 : SpellforceDataEditor.category_forms.SFControl
    {
        ...
        {
            category.set_element_variant(current_element, 4, Utility.TryParseUInt16(textBox4.Text));
        }

        private void textBox5_TextChanged(object sender, EventArgs e)
        {
            category.set_element_variant(current_element, 5, Utility.TryParseUInt16(textBox5.Text));
        }

        private void textBox6_TextChanged(object sender, EventArgs e)
        {
            category.set_element_variant(current_element, 6, Utility.TryParseInt16(textBox6.Text));
        }

        private void textBox7_TextChanged(object sender, EventArgs e)
        {
            category.set_element_variant(current_element, 7, Utility.TryParseInt16(textBox7.Text));
        }
        ...
        {
            category.set_element_variant(current_element, 10, Utility.TryParseUInt16(textBox11.Text));
        }

        private void textBox8_TextChanged(object sender, EventArgs e)
        {
            category.set_element_variant(current_element, 11, Utility.TryParseUInt16(textBox8.Text));
        }
